...
export function IntegrationsBar() {
  return (
    <section className="py-16 px-8 bg-cream-secondary">
      <motion.div
      ...
      >
        <motion.p
          variants={REVEAL}
          className="font-mono text-2xs tracking-[0.2em] uppercase text-brand-orange text-center mb-10"
        >
        ...
        <motion.p
          variants={REVEAL}
          className="text-warm-gray font-light text-sm leading-[1.7]"
        >
