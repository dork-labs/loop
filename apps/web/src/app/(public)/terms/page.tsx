    ...
    <div className="container-narrow py-12">
      <article className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Loop provides a web-based interface for Claude Code, built with the Claude Agent SDK. We
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            The service and its original content, features, and functionality are owned by Loop and
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            through our service. We do not endorse any user content and expressly disclaim any
            liability related to user content.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed uppercase">
            In no event shall Loop, its directors, employees, partners, agents, suppliers, or
