      ...
      <article className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            understand how you interact with the site. Cookies are widely used
            to make websites work efficiently and provide a better user
            experience.
          </p>
        </section>
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                session management, and accessibility. You cannot opt out of
                these cookies as they are required for the site to work.
              </p>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            When you first visit our website, you will be shown a cookie consent
            banner that allows you to accept or customize your cookie
            preferences. You can change your preferences at any time.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Some cookies on our website are set by third-party services. These
            may include:
          </p>
          <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            respective privacy policies of these providers for more information.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            The length of time a cookie remains on your device depends on its
            type:
          </p>
          <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4">
            <li>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Our consent preferences are stored for 12 months before we ask you
