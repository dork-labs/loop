...
<Callout type="info">
  This guide assumes you have Node.js 20+, npm, and Docker installed. No external database needed — Docker provides a local PostgreSQL instance.
</Callout>
...
<Callout type="info">
  The `.env.example` files contain pre-filled defaults that work immediately for local development. No manual editing required.
</Callout>
