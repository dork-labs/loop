---
title: Templates
description: List, inspect, and promote prompt template versions using the loop CLI.
---
...
```bash
loop templates promote <templateId> <versionId>
```
