/** OpenHands microagent file content for Loop integration. Sourced from packages/loop-skill/templates/openhands-loop.md. */
export const OPENHANDS_MICROAGENT_CONTENT = `---
name: loop
agent: CodeActAgent
