...
| `/spec:decompose` | Disk-first decomposition  | Background agent writes JSON+MD to disk; main context reads JSON and creates tasks (subagents can't use task tools) |
